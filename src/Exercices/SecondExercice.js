    ...
    return (
        <>
            <h3>
                ...
                <input onChange={alterarNome} placeholder="Digite o seu Nome" />
                <input onChange={alterarSalario} placeholder="Digite seu salario" />
                <input onChange={alterarReajuste} placeholder="Digite o valor do reajuste" />

                <p>Senhor(a) {YourName},</p>
                <p>Seu salario atual é: R${Salario}</p>
                <p>O reajuste será de: {Reajuste} %</p>
                <p>O seu salario reajustado será de: R${resultado}. Senhora {YourName}</p><br/><br/><br/>
            </h3>
        </>
    );
}
